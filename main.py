...
def main(page: ft.Page):
    ...
    drop_depart = ft.Dropdown(label='Подразделение', width=500) #alignment=ft.alignment.center
    ...
    phone_field = ft.TextField(label='Номер телефона', width=500, prefix_text='7', icon=ft.icons.PHONE)
    ...
    page.add(cont_titl, cont_company, cont_depart, cont_theme, cont_subject, cont_phone, cont_comment)
